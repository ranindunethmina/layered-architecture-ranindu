...
public class ManageCustomersFormController {
    ...
    lk.ijse.layeredarchitecture.bo.custom.customerBO customerBO = (lk.ijse.layeredarchitecture.bo.custom.customerBO) BOFactory.getBoFactory().getBO(BOFactory.BOTypes.CUSTOMER);
